...
module.exports = require('machine').build({
  ...
  friendlyName: 'Build Schema',


  description: 'Build a schema object that is suitable for using in a Create Table query.',
  ...
  fn: function buildSchema(inputs, exits) {
    ...
    var columns = _.map(inputs.definition, function map(attribute, name) {
    ...
    var primaryKeys = _.keys(_.pick(inputs.definition, function findPK(attribute) {
