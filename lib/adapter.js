...
module.exports = (function sailsPostgresql() {
  ...
  var adapter = {
    ...
    avg: function avg(datastoreName, tableName, query, cb, meta) {
      var datastore = datastores[datastoreName];
      var models = modelDefinitions[datastoreName];
      Helpers.avg({
        datastore: datastore,
    ...
    sum: function sum(datastoreName, tableName, query, cb, meta) {
      var datastore = datastores[datastoreName];
      var models = modelDefinitions[datastoreName];
      Helpers.sum({
        datastore: datastore,
    ...
    count: function count(datastoreName, tableName, query, cb, meta) {
      var datastore = datastores[datastoreName];
      var models = modelDefinitions[datastoreName];
      Helpers.count({
        datastore: datastore,
