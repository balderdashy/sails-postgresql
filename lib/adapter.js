...
module.exports = (function() {
  ...
  var adapter = {
    ...
    //  ╩╚═╚═╝╚═╝╩╚═╝ ╩ ╚═╝╩╚═  ╚═╝╚═╝╝╚╝╝╚╝╚═╝╚═╝ ╩ ╩╚═╝╝╚╝
    //
    registerConnection: function registerConnection(connectionConfig, collections, cb) {
      var self = this;
      ...
      .exec(function createManagerCb(err, report) {
        ...
        _.each(collections, function buildSchema(val, key) {
        ...
        async.map(_.keys(collections), function describe(colName, cb) {
    ...
    describe: function describe(datastoreName, table, cb) {
      spawnConnection(datastoreName, function describeQuery(connection, cb) {
        ...
        var collection = datastoreConfig.collections[table];
        var tableName = table;
